...
[Run Quiz](./quiz.sh){: onclick="window.open('terminalizer://path/to/your/terminalizer/file'); setTimeout(() => {document.getElementById('terminalizer').terminal.run('bash ./quiz.sh');}, 1000);" }
